...
from VIVAANXMUSIC.core.dir import COUPLE_DIR
from VIVAANXMUSIC.mongo.couples_db import get_couple, save_couple


ASSETS = Path("VIVAANXMUSIC/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "vivaan/couple.png").convert("RGBA")
